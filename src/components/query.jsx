    ...
    const columns = [
        ...
        },
        {
            ...
            selector: state => {
                const commanbutton = (
                    <>
                            <button className="bg-[#00C0EF] w-[2.5rem] h-[2.125rem] flex items-center justify-center rounded-[3px]">
                                <img src="/src/assets/edit.svg" alt="" title="Edit" className=" w-[0.875rem] h-[1.063rem]" />
                            </button>
                            <button className="bg-[#DD4B39] w-[2.5rem] h-[2.125rem] flex items-center justify-center rounded-[3px]">
                ...
                if (state.roomName == null) {
                    action.push(
                            <div className="flex w-[10.1vw] justify-between">
                                {commanbutton}
                            </div>
                    )
                }
                    ...
                    <div className="flex flex-col justify-between h-[81.846vh]">
                        <div className="bg-[white] h-[60.761vh] w-[82.031vw] border-t-[3px] border-[#D2D6DE] rounded-[3px] flex justify-center shadow-sm shadow-[black]/20 ">
                            <div className="w-[98%] flex flex-col border-t-2 border-blue-500 ">
                                ...
                                <DataTable data={filterQueries} columns={columns} pagination paginationPerPage={3}></DataTable>
                            </div>
                        </div>
